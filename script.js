...
const translations = {
    'es': {
        ...
        'txt-p-low-name': 'Temporada Baja', 'txt-p-low-dates': 'Octubre — Abril', 'txt-p-low-note': '~79€/noche',
        'txt-p-mid-name': 'Temporada Media', 'txt-p-mid-dates': 'May, Jun, Sep', 'txt-p-mid-note': '~107€/noche',
        ...
        'txt-price-disclaimer': '* Precios orientativos para 4 personas. El precio final varía según el número de huéspedes.',
    ...
    'en': {
        ...
        'txt-p-low-name': 'Low Season', 'txt-p-low-dates': 'October — May', 'txt-p-low-note': '~€79/night',
        'txt-p-mid-name': 'Mid Season', 'txt-p-mid-dates': 'Jun, Sep', 'txt-p-mid-note': '~€107/night',
        ...
        'txt-price-disclaimer': '* Indicative prices for 4 guests. Final price varies depending on the number of guests.',
    ...
    'fr': {
        ...
        'txt-p-low-name': 'Basse Saison', 'txt-p-low-dates': 'Octobre — Mai', 'txt-p-low-note': '~79€/nuit',
        'txt-p-mid-name': 'Moyenne Saison', 'txt-p-mid-dates': 'Juin, Sep', 'txt-p-mid-note': '~107€/nuit',
        ...
        'txt-price-disclaimer': '* Prix indicatifs pour 4 personnes. Le prix final varie selon le nombre de voyageurs.',
